...
$Form1_1 = GUICreate("DrMobile", 486, 320, 353, 229, -1, $WS_EX_ACCEPTFILES)
GUISetBkColor(0xFFFFFF)
$Pic1 = GUICtrlCreatePic(@TempDir & "\logo.jpg", 17, 25, 250, 50)
        ...
        Case $Button1 ; Button "Install"
            ...
            Else
                ...
                For $i = 0 To UBound($toInstall) - 1
                    ...
                    EndIf
                Next
                    MsgBox($MB_ICONINFORMATION, "Listo", "Process Done")
            EndIf
